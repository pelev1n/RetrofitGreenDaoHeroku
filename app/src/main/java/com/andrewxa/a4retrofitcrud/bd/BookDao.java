...
public class BookDao extends AbstractDao<Book, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Published = new Property(4, long.class, "published", false, "PUBLISHED");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK\" (" + //
                ...
                "\"PUBLISHED\" INTEGER NOT NULL );"); // 4: published
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Book entity) {
        ...
        stmt.bindLong(5, entity.getPublished());
    }
    ...
    public Book readEntity(Cursor cursor, int offset) {
        Book entity = new Book( //
            ...
            cursor.getLong(offset + 4) // published
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Book entity, int offset) {
        ...
        entity.setPublished(cursor.getLong(offset + 4));
     }
